...
const SLIDES = [
  { img: '/images/hero-1.jpg', emoji: '🚀', fa: ['یادگیری انگلیسی،', 'به سبک خودت'], desc: 'با دستیار هوشمند فارسی‌زبان، لغات تصویری و آزمون‌های جذاب، از صفر تا مکالمه قدم‌به‌قدم جلو برو.' },
  { img: '/images/hero-2.jpg', emoji: '🌍', fa: ['دنیای زبان،', 'توی جیب تو'], desc: 'هر کلمه‌ای که می‌خوای جستجو کن، تلفظ واقعی بشنو و با تصویر و مثال ماندگارش کن.' },
  { img: '/images/hero-3.jpg', emoji: '✨', fa: ['با دوستات یاد بگیر،', 'تو «محفل» گپ بزن'], desc: 'یه جامعهٔ امن و پرانرژی که توش با هم‌کلاسی‌ها چت می‌کنی، سوال می‌پرسی و با هم رشد می‌کنی.' },
];
